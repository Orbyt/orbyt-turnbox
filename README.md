This is Turnbox (http://noht.co.jp/turnbox ) repackaged for [Meteor](http://meteor.org). To add this to your project, simply type `meteor add orbyt:turnbox` in your console and hit enter. 
